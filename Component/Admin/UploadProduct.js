    ...
    const Upload_product_handler = async () => {
        ...
        if (Image1 == "" && Image2 == "" && Image3 == ""){
            ...
            try {
                ...
                let Insert_product_url = URL.RequestAPI ; 
                ...
                let Insert_product_option = {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    body: JSON.stringify(Insert_product_data)
                }; 

                let Insert_product_request = await fetch(Insert_product_url, Insert_product_option); 
                let Insert_product_response = await Insert_product_request.json() ; 
                let Insert_product_STATUS = Insert_product_response.Status ; 
